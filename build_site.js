...
function compilePage(contentHTML, pageTitle, pageDesc, pathPrefix = '', activeNav = '', extraHead = '') {
  ...
  let html = layoutTemplate
    ...
    .replace(/\{\{LOGO_IMAGE\}\}/g, resolveAssetPath(siteData.settings.logoImage || 'images/logo/logo.png') + '?v=' + Date.now())
    .replace(/\{\{FAVICON_IMAGE\}\}/g, resolveAssetPath(siteData.settings.faviconImage || 'images/logo/favicon.png') + '?v=' + Date.now())
